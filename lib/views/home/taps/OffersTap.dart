...
class OffersTap extends StatefulWidget {
  const OffersTap({Key? key}) : super(key: key);

  @override
  _OffersTapState createState() => _OffersTapState();
}

class _OffersTapState extends State<OffersTap> {
  @override
